...
CONFIGURE_ARGS="$CONFIGURE_ARGS --extra-ldflags=-L$TOOL_DIR/lib"
CONFIGURE_ARGS="$CONFIGURE_ARGS --extra-ldflags=-L$TOOL_DIR/lib64"

# 【核心修复】强行补上静态库缺失的数学库依赖
CONFIGURE_ARGS="$CONFIGURE_ARGS --extra-libs=-lm"
